...
/// b *= (e), for writing into a pointer, and 
/// !*(e), for dereferencing a pointer. 
/// Moreover, in order to state a meaningful post-condition, you will need:
